...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    bankBranchPlaceholder: "e.g., Downtown Branch",
    bankSwiftPlaceholder: "e.g., CHASUS33",
    bankAccountNumberPlaceholder: "e.g., 123456789",
    bankAccountHolder: "Account Holder",
    bankAccountHolderPlaceholder: "e.g., John Doe",
    iban: "IBAN",
    ibanPlaceholder: "e.g., TR...",
    // Locations
    locations: "Locations",
    location: "Location",
  ...
  tr: {
    ...
    bankBranchPlaceholder: "örn: Merkez Şube",
    bankSwiftPlaceholder: "örn: ZIRATRIS",
    bankAccountNumberPlaceholder: "örn: 123456789",
    bankAccountHolder: "Hesap Sahibi",
    bankAccountHolderPlaceholder: "örn: Ahmet Yılmaz",
    iban: "IBAN",
    ibanPlaceholder: "örn: TR...",
    // Locations
    locations: "Konumlar",
    location: "Konum",
