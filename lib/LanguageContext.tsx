...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    pricePeriodStart: "Price Period Start",
     ...
     inactive: "Inactive",
     credits: "Credits",
     exclusiveSeatInfo: "Exclusive seats are premium seats with higher credit cost.",
     ...
     rows: "Rows",
     columns: "Columns",
     gridSizeHelp: "Optional: Define grid size (e.g., 3 rows x 4 columns = 3x4 grid)",
  ...
  tr: {
    ...
    pricePeriodStart: "Fiyat Dönemi Başlangıcı",
     ...
     inactive: "Pasif",
     credits: "Kredi",
     exclusiveSeatInfo: "Özel koltuklar yüksek kredi maliyetli premium koltuklardır.",
     ...
     rows: "Satırlar",
     columns: "Sütunlar",
     gridSizeHelp: "Opsiyonel: Grid boyutunu tanımlayın (örn: 3 satır x 4 sütun = 3x4 grid)",
     instructorSeatInfo: "Eğitmen pozisyonu - üyeler tarafından rezerve edilemez.",
